package romilp.foodrecpie.ui.fragments.overview
...
import romilp.foodrecpie.bindingAdapters.RecipesRowBinding
import romilp.foodrecpie.databinding.FragmentOverviewBinding
...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val args = arguments                    //cuva rezultat izabranog recepta
        val myBundle: Result? = args!!.getParcelable(RECIPE_RESULT_KEY)

        //popunjavamo overview
        binding.mainImageView.load(myBundle!!.image)
        binding.titleTextView.text = myBundle.title
        binding.likesTextView.text = myBundle.aggregateLikes.toString()
        binding.timeTextView.text = myBundle.readyInMinutes.toString()
        RecipesRowBinding.parseHtml(binding.summaryTextView, myBundle.summary)      // ubacujemo summary text, i popravljamo tekst da ne bude html
